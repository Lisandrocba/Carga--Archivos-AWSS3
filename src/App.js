...
function App() {
  ...
  return (
    <div className="bg-slate-800 text-white h-screen w-screen flex flex-col justify-center items-center">
      <h1 className="text-2xl">Formulario para cargar archivos en AWS s3</h1>
      <form className="flex flex-col justify-center items-center bg-slate-900 rounded-3xl p-10 my-3 shadow-lg shadow-slate-700 w-1/3">
        <input
          className="rounded-md bg-slate-700 px-3 py-1 mb-5 text-center"
          placeholder="Nombre del archivo"
          type="text"
          onChange={e=> setArchivos({...archivos, name : e.target.value})}
        />
